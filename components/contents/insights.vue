<template>
  <section class="max-w-6xl mx-auto pt-24 px-4 flex flex-col md:flex-row justify-between gap-20">
    <div class="space-y-8 max-w-[375px] lg:py-24 relative z-10">
    ...
    <div class="sm:hidden">
      <img class="w-full" src="/img/analytics-mobile.svg">
    </div>
  </section>
</template>
